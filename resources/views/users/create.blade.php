                    ...
                    <form enctype="multipart/form-data" method="POST" action="{{ route('users.store') }}">
                        ...
                        <div class="form-control mb-3">
                            <div>
                                ...
                                <x-text-input id="title" class="block mt-1 w-full" type="text" name="name" :value="old('name')" required autofocus autocomplete="name" />
                        ...
                        <div class="form-control mb-3">
                            <div>
                                ...
                                <x-text-input id="author" class="block mt-1 w-full" type="email" name="email" :value="old('email')" required autofocus autocomplete="email" />
                        ...
                        <div class="form-control mb-3">
                            <div>
                                ...
                                <x-text-input id="author" class="block mt-1 w-full" type="text" name="password" :value="old('password')" required autofocus autocomplete="" />
